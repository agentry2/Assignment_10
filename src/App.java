...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        if (length < 8 || length > 16) {
            System.out.println("Please try again and input a valid password between lengths 8 and 16!");
            System.exit(0);
        }
        ...
        System.out.println("Great job! Your password meets all the requirements!");
